...
export const Workbench = memo(({ chatStarted, isStreaming, sendMessage }: WorkspaceProps) => {
  ...
  const [selectedDevice, setSelectedDevice] = useState<string>("tab");
            ...
            <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
              <div className="flex items-center justify-between px-3 py-2 border-b border-bolt-elements-borderColor">
                ...
                {selectedView === 'preview' && (
                  <div className="inline-flex rounded-lg border border-bolt-elements-borderColor">
                    <button
                      onClick={() => {
                      ...
                      className={`inline-flex items-center px-4 py-1 gap-2 text-sm ${selectedDevice === 'laptop' ? 'bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent' : 'text-gray-600 hover:text-gray-700 bg-transparent'}  border-r border-bolt-elements-borderColor`}>
                    ...
                    <button
                      onClick={() => {
                        ...
                        setIsMobile(false);
                        setSelectedDevice('tab')
                      }}
                      className={`inline-flex items-center px-4 py-1 gap-2 text-sm ${selectedDevice === 'tab' ? 'bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent' : 'text-gray-600 hover:text-gray-700 bg-transparent'} border-r border-bolt-elements-borderColor`}>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center px-4 py-1 gap-2 text-sm ${selectedDevice === 'mobile' ? 'bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent' : 'text-gray-600 hover:text-gray-700 bg-transparent'}`}>
                ...
                <div className='flex items-center gap-1.5'>
                  {/* <PanelHeaderButton
                    ...
                    onClick={() => {
                      if (sendMessage) {
                        // Create a synthetic event that matches React.UIEvent
                        ...
                        sendMessage(syntheticEvent, "Deploy This Application");
                      }
                    }}
                  >
